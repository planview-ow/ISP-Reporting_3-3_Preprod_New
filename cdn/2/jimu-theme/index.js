  ...
  `)(n)}
    ...
    */
    ...
    ${/Avenir/gim.test(n.body.fontFamily)&&e.css`
      [lang="vi"] body {
        font-family: "Montserrat", 'Lucida Grande', Montserrat, Verdana, Geneva, sans-serif;
      }
    `}
